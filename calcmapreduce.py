...
#create class to contain all our methods
class CalcMapReduce(object):
    ...
    def multiplyList(self, *a): #fn to multiply a list of numbers and return the product
    ...
    def reciprocalList(self, *a): #fn to compute reciprocal of list of numbers and return answers in a list
    ...
    def sineList(self, *a): #convert list of angles into list of sine of angles
    ...
    def squareList(self, *a): #function that squares every number in a list and returns that in a list
    ...
    def squareGenerator(self, *a): #function to generate a repeated square from list of inputs
    ...
    def tangentList(self, *a):  #convert list of angles into list of tan of angles
